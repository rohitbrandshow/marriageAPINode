...
const countData = require('./routes/profileCountRoutes'); 
app.use('/api/count', countData);

const atlasSearchRoutes = require('./routes/atlasSearchRoutes');
app.use('/api/atlas-search', atlasSearchRoutes);

const searchData = require('./routes/searchRoutes'); 
app.use('/api/search', searchData);

const adminFunction = require('./routes/adminRoutes'); 
